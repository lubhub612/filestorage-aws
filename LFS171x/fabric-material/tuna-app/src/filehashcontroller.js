...
return{
	get_all_file: function(req, res){
		console.log("getting all file from database: ");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // queryAllFile - requires no arguments , ex: args: [''],
		    const request = {
	...
	get_file: function(req, res){
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // queryFile - requires 1 argument, ex: args: ['4'],
		    const request = {
		        chaincodeId: 'filestorage-app',
		        txId: tx_id,
		        fcn: 'queryFile',
		    ...
		    console.error('Failed to query successfully :: ' + err);
		    res.send("Could not found  file hash")
		});
	},
	...
	var array = req.params.filehashnew.split("-");
		...
		Fabric_Client.newDefaultKeyValueStore({ path: store_path
		    ...
		    // changeFileHash - requires 2 args , ex: args: ['1', '1234567'],
		    // send proposal to endorser
		    var request = {
		        //targets : --- letting this default to the peers assigned to the channel
		        chaincodeId: 'filestorage-app',
		    ...
		    console.error('Failed to invoke successfully :: ' + err);
		    res.send("Error: no file hash found");
		});
